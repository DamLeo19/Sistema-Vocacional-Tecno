...
const routes = [
  ...
  {
    path: '/intereses_usuario', // Asegúrate de que el path sea correcto
    name: 'InteresesUsuario', // Nombre sin espacios
    component: InteresesUsuario, // Componente importado correctamente
  }
];
